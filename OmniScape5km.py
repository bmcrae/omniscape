...
options['radius'] = 18# In PIXELS. Search radius, with sources activated within the radius and outside of the center (target) block.
...
options['outputDirBase'] = 'draft6_5km'
...
options['startStripe'] = 10 # First stripe to process. Use 0 to ignore.
options['endStripe'] = 130 # Stops after processing this stripe. 0 to ignore.
...
from math import *
options['fadeInDist'] = options['radius'] #(options['blockSize'])#-1)/2#/4.0#sqrt(2)*(options['blockSize']/2.0)#options['radius']/2 #
