...
options['projectDir'] = r'C:\DATADRIVE\DUKE_PNW_DATA\PNW_Omniscape_180m'#r'D:\Users\bmcrae\Duke_PNW_Omniscape\d8_omniscape' #r'C:\DATADRIVE\DUKE_PNW_DATA\PNW_OmniScape'# this is where all the input data are, and where out directory will be created.
options['resisRasterBase'] = 'ones_oly.tif'#'rNullFadeTestClip2.tif'#'ones.tif'#
options['outputDirBase'] = 'NullCorrection_BS31_1x1'
...
options['startBand'] = 11#4#16#4# First band to process. Use 0 to ignore.
options['endBand'] = 11#15# # Stops after processing this band. Use 0 to ignore.
options['startStripe'] = 11 # First stripe to process. Use 0 to ignore.
options['endStripe'] = 11
...
options['useCorrectionArray'] = False
