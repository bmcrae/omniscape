...
options['resisRasterBase'] = 'DUKE_CIRCUITSCAPE_resistances_draft6_R_max_270m_clip.tif'
options['outputDirBase'] = 'd6_540m_50kmNoDisteqNewKernel'
...
options['endBand'] = 43 # Stops after processing this band. Use 0 to ignore.
options['startStripe'] = 80 # First stripe to process. Use 0 to ignore.
options['endStripe'] = 81 # Stops after processing this stripe. 0 to ignore.
...
# SPECIAL FUNCTIONS
options['calcNull'] = True # Calculates a 'null' result with all resistances = 1.
